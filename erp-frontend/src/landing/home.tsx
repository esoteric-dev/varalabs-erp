...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-teal-100 dark:selection:bg-teal-900 relative overflow-hidden transition-colors duration-300">
      {/* Global background mesh */}
      <div className="mesh-gradient fixed inset-0 pointer-events-none" />

      {/* Floating decorative orbs */}
      <div className="fixed top-20 -left-32 w-96 h-96 rounded-full bg-gradient-to-br from-teal-200/30 to-cyan-200/20 dark:from-teal-500/10 dark:to-cyan-500/10 blur-3xl animate-float pointer-events-none" />
      <div className="fixed bottom-20 -right-32 w-96 h-96 rounded-full bg-gradient-to-br from-violet-200/20 to-indigo-200/20 dark:from-violet-500/10 dark:to-indigo-500/10 blur-3xl animate-float-reverse pointer-events-none" />

      {/* Top Navigation */}
      <nav className="glass sticky top-0 z-50 border-b border-white/60 dark:border-white/10">
        <div className="flex items-center justify-between px-8 py-4 max-w-[1200px] mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8 font-medium text-sm text-slate-500 dark:text-slate-400">
            ...
            <a href="#solutions" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors">Solutions</a>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-9 h-9 rounded-lg border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-teal-600 dark:hover:text-teal-400 hover:border-teal-200 dark:hover:border-teal-800 transition-all"
              aria-label="Toggle dark mode"
            >
              {dark ? <Sun className="w-4 h-4" /> : <Moon className="w-4 h-4" />}
            </button>
            <button className="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-teal-700 dark:hover:text-teal-400 transition-colors">
              Log In
            </button>
      ...
      <main className="relative z-10">
        ...
        <section className="max-w-[1200px] mx-auto px-8 pt-20 pb-24">
          <div className="flex flex-col items-center text-center gap-6">
            <div className="animate-fade-in-up opacity-0">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-50 dark:bg-teal-500/10 border border-teal-100 dark:border-teal-500/20 text-xs font-semibold text-teal-700 dark:text-teal-400 mb-6">
            ...
            <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 leading-relaxed max-w-2xl animate-fade-in-up opacity-0 animation-delay-200">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-2 animate-fade-in-up opacity-0 animation-delay-300">
              <button className="group px-7 py-3.5 text-sm font-semibold text-white bg-slate-900 dark:bg-white dark:text-slate-900 rounded-xl hover:bg-slate-800 dark:hover:bg-slate-100 transition-all shadow-lg shadow-slate-900/20 dark:shadow-white/10 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2">
                Get Started Today
                <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-0.5" />
              </button>
              <button className="flex items-center gap-2.5 px-5 py-3.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-teal-600 dark:hover:text-teal-400 transition-colors group">
                <div className="w-9 h-9 rounded-full bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-sm flex items-center justify-center group-hover:shadow-md transition-shadow">
          ...
          <div className="relative mt-16 max-w-4xl mx-auto animate-scale-in opacity-0 animation-delay-500">
            ...
            <div className="relative bg-white dark:bg-slate-900 border border-gray-200/80 dark:border-slate-700/80 rounded-2xl shadow-2xl overflow-hidden">
              {/* Window chrome */}
              <div className="flex items-center gap-2 px-5 py-3.5 bg-gray-50 dark:bg-slate-800/80 border-b border-gray-100 dark:border-slate-700">
                ...
                <div className="flex-1 mx-12">
                  <div className="w-64 h-6 bg-gray-100 dark:bg-slate-700 rounded-lg mx-auto" />
                </div>
              </div>
              {/* Dashboard content */}
                ...
                <div className="col-span-3 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={stat.label} className="bg-gray-50 dark:bg-slate-800/60 rounded-xl p-4 space-y-2">
                        <div className="text-xs text-slate-400">{stat.label}</div>
                        <div className="text-lg font-bold text-slate-700 dark:text-slate-200">{stat.value}</div>
                  ...
                  <div className="h-28 bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-teal-500/10 dark:to-cyan-500/10 rounded-xl border border-teal-100/50 dark:border-teal-500/20 flex items-center justify-center">
                    <BarChart3 className="w-10 h-10 text-teal-300 dark:text-teal-600" />
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="h-5 w-20 bg-slate-100 dark:bg-slate-800 rounded" />
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="flex items-center gap-2.5 p-2.5 bg-gray-50 dark:bg-slate-800/60 rounded-lg">
                      <div className="w-7 h-7 rounded-full bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-800 dark:to-emerald-800 flex-shrink-0" />
                      <div className="flex-1 space-y-1.5">
                        <div className="h-2 w-full bg-gray-100 dark:bg-slate-700 rounded" />
                        <div className="h-1.5 w-2/3 bg-gray-100 dark:bg-slate-700 rounded" />
                      </div>
                    </div>
                  ))}
                </div>
        ...
        {/* ===== TRUSTED BY ===== */}
        <section className="border-y border-gray-100 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50">
          <div className="max-w-[1200px] mx-auto px-8 py-10 flex flex-col items-center gap-6">
            <span className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Trusted by leading institutions</span>
            <div className="flex flex-wrap justify-center gap-x-12 gap-y-4 text-slate-400 dark:text-slate-500">
              {['Greenwood Academy', "St. Mary's School", 'Oakridge Int.', 'Delhi Public School', 'Ryan International'].map((name) => (
                <span key={name} className="flex items-center gap-2 text-sm font-semibold hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
        ...
        <section id="features" className="max-w-[1200px] mx-auto px-8 py-24">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-lg max-w-2xl mx-auto">Built from the ground up for modern educational institutions, with powerful features that just work.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group p-6 bg-white/80 dark:bg-slate-900/60 border border-gray-100 dark:border-slate-800 rounded-2xl hover:shadow-lg hover:shadow-gray-200/50 dark:hover:shadow-black/30 hover:-translate-y-1 transition-all duration-300"
              >
        ...
        <section id="solutions" className="bg-white/60 dark:bg-slate-900/40 border-y border-gray-100 dark:border-slate-800">
          <div className="max-w-[1200px] mx-auto px-8 py-24">
            <div className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Built for every role</h2>
              <p className="text-slate-500 dark:text-slate-400 text-lg max-w-2xl mx-auto">Whether you're an admin, teacher, student, or parent -- Synapse adapts to the way you work.</p>
            </div>

            <div className="max-w-3xl mx-auto">
              <div className="bg-white dark:bg-slate-900 border border-gray-200/80 dark:border-slate-700/80 rounded-2xl shadow-lg shadow-gray-200/40 dark:shadow-black/30 overflow-hidden">
                {/* Tabs */}
                  ...
                  {(['Office', 'Teacher', 'Student', 'Guardian'] as const).map((tab) => (
                    <button
                      ...
                      className={`flex-1 py-4 text-sm font-medium text-center transition-all relative ${
                        activeTab === tab
                          ? 'text-teal-700 dark:text-teal-400 bg-teal-50/50 dark:bg-teal-500/5'
                ...
                <div className="p-8" key={activeTab}>
                  <div className="animate-slide-in-right">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                      {/* Left: text */}
                      <div>
                        <h4 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-2">{active.title}</h4>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">{active.subtitle}</p>
                        <ul className="space-y-3">
                          {active.bullets.map((b, i) => (
                            <li key={i} className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-300">
                              <div className="w-6 h-6 rounded-full bg-teal-50 dark:bg-teal-500/10 border border-teal-100 dark:border-teal-500/20 flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-800 dark:to-slate-800/60 border border-gray-100 dark:border-slate-700 rounded-xl h-48 flex flex-col items-center justify-center gap-2">
                          <Monitor className="w-7 h-7 text-slate-300 dark:text-slate-600" />
                          <span className="text-xs font-medium text-slate-400 dark:text-slate-500">{active.mockLabel}</span>
                        </div>
                        <div className="bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-800 dark:to-slate-800/60 border border-gray-100 dark:border-slate-700 rounded-xl h-48 flex flex-col items-center justify-center gap-2">
                          <Smartphone className="w-7 h-7 text-slate-300 dark:text-slate-600" />
                          <span className="text-xs font-medium text-slate-400 dark:text-slate-500">{active.mockSublabel}</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <section className="max-w-[1200px] mx-auto px-8 py-24">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={stat.label} className="flex flex-col items-center gap-3 p-8 bg-white/80 dark:bg-slate-900/60 border border-gray-100 dark:border-slate-800 rounded-2xl hover:shadow-md dark:hover:shadow-black/20 transition-shadow">
                <div className="w-12 h-12 rounded-xl bg-teal-50 dark:bg-teal-500/10 border border-teal-100 dark:border-teal-500/20 flex items-center justify-center text-teal-500 dark:text-teal-400">
                  {stat.icon}
                </div>
                <span className="text-3xl font-bold text-slate-900 dark:text-white">{stat.value}</span>
                <span className="text-sm text-slate-400 dark:text-slate-500 font-medium">{stat.label}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-[1200px] mx-auto px-8 pb-24">
          <div className="relative overflow-hidden rounded-3xl shadow-2xl shadow-slate-900/30 dark:shadow-black/50">
        ...
        {/* ===== FOOTER ===== */}
        <footer className="border-t border-gray-200/60 dark:border-slate-800 bg-white/40 dark:bg-slate-900/40">
          <div className="max-w-[1200px] mx-auto px-8 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Synapse</span>
            </div>
            ...
            <p className="text-xs text-slate-300 dark:text-slate-600">&copy; 2025 Synapse Technologies</p>
            <div className="flex gap-3">
              {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
                <div key={i} className="w-8 h-8 rounded-full bg-gray-50 dark:bg-slate-800 border border-gray-100 dark:border-slate-700 flex items-center justify-center text-slate-400 dark:text-slate-500 hover:text-teal-600 dark:hover:text-teal-400 hover:border-teal-100 dark:hover:border-teal-800 hover:bg-teal-50 dark:hover:bg-teal-500/10 cursor-pointer transition-all">
