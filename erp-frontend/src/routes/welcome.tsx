      ...
      <nav className="glass sticky top-0 z-50 border-b border-white/60">
        <div className="flex items-center justify-between px-8 py-4 max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="px-4 py-2 text-sm font-medium text-slate-600 hover:text-teal-700 transition-colors">
              Log In
            </Link>
      ...
      <main className="relative z-10">
        ...
        <section className="max-w-[1200px] mx-auto px-8 pt-20 pb-24">
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-2 animate-fade-in-up opacity-0 animation-delay-300">
              <Link to="/signup" className="group px-7 py-3.5 text-sm font-semibold text-white bg-slate-900 rounded-xl hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/20 hover:shadow-xl hover:shadow-slate-900/25 hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2">
                Get Started Today
          ...
          <div className="relative overflow-hidden rounded-3xl shadow-2xl shadow-slate-900/30">
            ...
            <div className="relative z-10 py-20 px-8 flex flex-col items-center text-center gap-6 text-white">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 mt-2">
                <Link to="/signup" className="px-8 py-4 text-sm font-semibold text-slate-900 bg-white rounded-xl hover:bg-teal-50 hover:text-teal-700 transition-all hover:shadow-lg hover:shadow-white/10 hover:-translate-y-0.5 active:translate-y-0">
                  Get Started Free
                </Link>
                <Link to="/login" className="px-8 py-4 text-sm font-semibold text-white border border-white/20 rounded-xl hover:bg-white/10 transition-all">
                  Sign In
                </Link>
              </div>
            </div>
        ...
        <footer className="border-t border-gray-200/60 bg-white/40">
          <div className="max-w-[1200px] mx-auto px-8 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-slate-300">&copy; 2025 Vara Labs</p>
